...
| `sandbox.secrets` | How backend API keys reach the sandbox: `"proxy"` (default) registers them as proxy-injected secrets and hands the sandbox a placeholder; `"env"` passes the values as plain variables. |
